 ...
 * @LastEditTime   : 2022-04-04 21:32:58
 * @Description    :  
-->
<template>
    ...
    <q-card-section class="q-py-md q-gutter-y-md">
      ...
      <div class="row">
        ...
        <q-editor
          ...
          filled
          dense
          v-model="detail_obj.content_zn"
          min-height="5rem"   
 
          @update:model-value="handle_content_zn_update"
        />
...
export default {
  ...
  created() {
    ...
    this.detail_obj.content_zn = ` <img src="http://127.0.0.1:17101/public/1.png" >`
  },
  methods: {
    handle_conform_edit() {},
    handle_cancel_edit() {},
