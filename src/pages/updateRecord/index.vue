 ...
 * @LastEditTime   : 2022-04-05 17:24:06
 * @Description    :  
-->
<template>
  <div class="q-pa-md">
...
export default {
  ...
  data() {
    return {
      ...
      //增加 API
      api_fn_create: api_updateRecord.handle_create,
      //删除 API
      api_fn_delete: api_updateRecord.handle_delete,
      //修改 API
      api_fn_update: api_updateRecord.handle_update,
      //查询 API
      api_fn_read: api_updateRecord.handle_read,
      //禁用 API
      api_fn_disable: api_updateRecord.handle_disable,
