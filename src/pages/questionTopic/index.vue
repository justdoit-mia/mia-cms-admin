...
export default {
  ...
  data() {
    return {
      ...
      //增加 API
      api_fn_create: api_questionTopic.handle_create,
      //删除 API
      api_fn_delete: api_questionTopic.handle_delete,
      //修改 API
      api_fn_update: api_questionTopic.handle_update,
      //查询 API
      api_fn_read: api_questionTopic.handle_read,
      //禁用 API 
      api_fn_disable:api_questionTopic.handle_disable,
