 ...
 * @LastEditTime   : 2022-04-05 17:25:07
 * @Description    :  
-->
<template>
  <div class="q-pa-md">
    ...
    >
      ...
      <template v-slot:body-cell-status="props">
        <q-td :props="props">
          <ShowBadge :value="props.row.status" :options="options_status" />
        </q-td>
      </template>
...
import ArticlePreview from "src/components/article/preview.vue";
...
export default {
  ...
  data() {
    return {
      ...
      //增加 API
      api_fn_create: api_article.handle_create,
      //删除 API
      api_fn_delete: api_article.handle_delete,
      //修改 API
      api_fn_update: api_article.handle_update,
      //查询 API
      api_fn_read: api_article.handle_read,
      //禁用 API
      api_fn_disable: api_article.handle_disable,
